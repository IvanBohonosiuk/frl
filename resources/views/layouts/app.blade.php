                        ...
                        @else
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                                    Повідомлення @include('messenger.unread-count')
                                </a>
                                <ul class="dropdown-menu" role="menu">
                                    <li><a href="{{ url('/messages') }}"><i class="fa fa-btn fa-sign-in"></i>Всі повідомлення</a></li>
                                    <li><a href="{{ url('/messages/create') }}"><i class="fa fa-btn fa-sign-in"></i>Нове повідомлення</a></li>
                                </ul>
                            </li>
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
